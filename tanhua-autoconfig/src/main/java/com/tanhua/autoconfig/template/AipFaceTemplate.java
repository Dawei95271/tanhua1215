...
public class AipFaceTemplate {
    ...
    public  boolean faceDetect(String imageUrl) {
        // 请求url
        ...
        try {
            ...
            Map ret = JSON.parseObject(result, Map.class);
            Integer error_code = (Integer) ret.get("error_code");
    ...
    private String getAuth() {
        ...
        String authHost = properties.getAuthHost();
